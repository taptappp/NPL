...
try:
    ...
    print("⚠️ CẢNH BÁO: Chưa cài underthesea. Kết quả dự đoán có thể không chính xác.")
...
MODEL_PATH = "saved_models/phobert_best.pt" # Đường dẫn model sau khi train xong
...
if os.path.exists(MODEL_PATH):
    ...
    print(f"⚠️ Không tìm thấy file weights tại {MODEL_PATH}. Model sẽ dự đoán ngẫu nhiên!")
